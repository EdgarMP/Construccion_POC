...
public class PreguntaMultiple {
    ...
    private ArrayList<Respuesta> preguntaRespuesas = null;
    ...
    public ArrayList<Respuesta> getPreguntaRespuesas() {
        return preguntaRespuesas;
    }

    public void setPreguntaRespuesas(ArrayList<Respuesta> preguntaRespuesas) {
        this.preguntaRespuesas = preguntaRespuesas;
    }
    ...
    public void setIsRequerida(boolean isRequerida) {
